...
export class MemoryManagementExample {
  ...
  async demonstrateConfigurationUpdates(): Promise<void> {
    ...
    // Note: Memory configuration is set during cache creation and cannot be updated at runtime
    // To change memory limits, a new cache instance would need to be created
