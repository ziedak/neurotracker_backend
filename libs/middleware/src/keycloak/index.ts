...
// Core exports
export { KeycloakService } from './service';
export { KeycloakMiddleware, createKeycloakPlugin, keycloakGuards } from './middleware';
export { KeycloakWebSocketMiddleware, createKeycloakWebSocketMiddleware } from './websocket.middleware';
export { 
...
export const KEYCLOAK_ROLE_PERMISSIONS = {
  admin: [
    ...
    'websocket:broadcast', 'websocket:admin', 'message:*'
  ],
  manager: [
    'user:read', 'user:write',
    'reports:read', 'api:write',
    'websocket:connect', 'websocket:send', 'websocket:receive',
    'message:chat', 'message:notification', 'message:data'
  ],
  user: [
    'user:read', 'api:read',
    'websocket:connect', 'websocket:send', 'websocket:receive',
...
export const WEBSOCKET_MESSAGE_ROLES = {
  ...
  'notification:receive': ['admin', 'manager', 'user', 'customer', 'readonly', 'viewer']
} as const;