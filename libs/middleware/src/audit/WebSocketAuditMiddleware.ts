 ...
 */
export interface WebSocketAuditMiddlewareConfig
 ...
 *
 * @template WebSocketAuditMiddlewareConfig - WebSocket audit-specific configuration
 */
export class WebSocketAuditMiddleware extends BaseWebSocketMiddleware<WebSocketAuditMiddlewareConfig> {
  ...
  constructor(
    ...
    } as WebSocketAuditMiddlewareConfig;
