 ...
 *
 * @template WebSocketAuthMiddlewareConfig - WebSocket authentication-specific configuration
 */
export class WebSocketAuthMiddleware extends BaseWebSocketMiddleware<WebSocketAuthMiddlewareConfig> {
  ...
  constructor(
    ...
    config: Partial<WebSocketAuthMiddlewareConfig> = {}
  ) {
    ...
    } as WebSocketAuthMiddlewareConfig;
   ...
   */
  static createRequireAuthConfig(): Partial<WebSocketAuthMiddlewareConfig> {
    return {
   ...
   */
  static createOptionalAuthConfig(): Partial<WebSocketAuthMiddlewareConfig> {
    return {
  ...
  static createRoleBasedConfig(
    roles: string[]
  ): Partial<WebSocketAuthMiddlewareConfig> {
    return {
...
export function createWebSocketAuthMiddleware(
  ...
  return new WebSocketAuthMiddleware(metrics, authService, config);
}
...
export const WS_AUTH_PRESETS = {
  requireAuth: (): Partial<WebSocketAuthMiddlewareConfig> =>
    WebSocketAuthMiddleware.createRequireAuthConfig(),

  optionalAuth: (): Partial<WebSocketAuthMiddlewareConfig> =>
    WebSocketAuthMiddleware.createOptionalAuthConfig(),

  adminOnly: (): Partial<WebSocketAuthMiddlewareConfig> =>
    WebSocketAuthMiddleware.createRoleBasedConfig(["admin"]),

  userOrAdmin: (): Partial<WebSocketAuthMiddlewareConfig> =>
    WebSocketAuthMiddleware.createRoleBasedConfig(["user", "admin"]),

  realtimeChat: (): Partial<WebSocketAuthMiddlewareConfig> => ({
  ...
  apiAccess: (): Partial<WebSocketAuthMiddlewareConfig> => ({
  ...
  development: (): Partial<WebSocketAuthMiddlewareConfig> => ({
  ...
  production: (): Partial<WebSocketAuthMiddlewareConfig> => ({
