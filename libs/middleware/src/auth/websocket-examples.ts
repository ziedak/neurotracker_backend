 ...
 * Comprehensive examples demonstrating WebSocketAuthMiddleware integration and configuration
 */
...
export function createBasicWebSocketAuthExample(
  ...
  return createWebSocketAuthMiddleware(metrics, authService, {
    name: "basic-ws-auth",
    requireAuth: true,
    jwtAuth: true,
    apiKeyAuth: false,
...
export function createDevelopmentWebSocketAuthExample(
  ...
  return createWebSocketAuthMiddleware(
    metrics,
    authService,
...
export const WS_TESTING_UTILS = {
  ...
  createMockMiddleware: () => {
    ...
    const middleware = createWebSocketAuthMiddleware(
      mockMetrics,
      mockAuthService,
      {
        name: "test-ws-auth",
