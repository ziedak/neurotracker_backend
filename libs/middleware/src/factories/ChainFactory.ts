...
} from "../base/MiddlewareChain";
import { WebSocketMiddlewareChain } from "../base/WebSocketMiddlewareChain";
...
export function createHttpMiddlewareChain(
  ...
  const chainConfig: MiddlewareChainConfig = {
    name: chainName,
  ...
  return new MiddlewareChain(metrics, chainConfig);
}
