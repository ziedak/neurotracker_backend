...
export class SecurityWebSocketMiddleware extends BaseWebSocketMiddleware<SecurityWebSocketConfig> {
  ...
  constructor(
    ...
    const defaultConfig: SecurityWebSocketConfig = {
  ...
  static createApiGatewayConfig(): Partial<SecurityWebSocketConfig> {
    return {
  ...
  static createDevelopment(
    metrics: IMetricsCollector,
    additionalConfig?: Partial<SecurityWebSocketConfig>
