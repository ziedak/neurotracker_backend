 ...
 */
export interface AdvancedWebSocketRateLimitConfig
 ...
 */
interface WebSocketRateLimitStrategy {
 ...
 */
class WebSocketIpStrategy implements WebSocketRateLimitStrategy {
  generateKey(context: WebSocketContext): string {
    return context.metadata.clientIp || "unknown";
  }
}

class WebSocketUserStrategy implements WebSocketRateLimitStrategy {
  generateKey(context: WebSocketContext): string {
    return context.userId || context.connectionId || "anonymous";
  }
}

class WebSocketConnectionStrategy implements WebSocketRateLimitStrategy {
  generateKey(context: WebSocketContext): string {
 ...
 *
 * @template AdvancedWebSocketRateLimitConfig - WebSocket rate limiting-specific configuration
 */
export class WebSocketRateLimitMiddleware extends BaseWebSocketMiddleware<AdvancedWebSocketRateLimitConfig> {
  private readonly rateLimiter: RateLimitingCacheAdapter;
  private readonly connectionLimiter?: RateLimitingCacheAdapter;
  private readonly strategies: Map<string, WebSocketRateLimitStrategy>;
  private readonly cacheService: CacheService;

  constructor(
    metrics: IMetricsCollector,
    config: Partial<AdvancedWebSocketRateLimitConfig> = {}
  ) {
    ...
    } as AdvancedWebSocketRateLimitConfig;
    ...
    this.strategies = new Map<string, WebSocketRateLimitStrategy>();
  ...
  private initializeCacheService(): CacheService {
    ...
    throw new Error(
      "CacheService initialization required. " +
        "WebSocketRateLimitMiddleware needs to be integrated with service locator pattern " +
   ...
   */
  static createGeneralConfig(): Partial<AdvancedWebSocketRateLimitConfig> {
    return {
   ...
   */
  static createStrictConfig(): Partial<AdvancedWebSocketRateLimitConfig> {
    return {
   ...
   */
  static createGamingConfig(): Partial<AdvancedWebSocketRateLimitConfig> {
    return {
   ...
   */
  static createChatConfig(): Partial<AdvancedWebSocketRateLimitConfig> {
    return {
   ...
   */
  static createDevelopmentConfig(): Partial<AdvancedWebSocketRateLimitConfig> {
    return {
   ...
   */
  static createProductionConfig(): Partial<AdvancedWebSocketRateLimitConfig> {
    return {
...
export function createWebSocketRateLimitMiddleware(
  ...
  return new WebSocketRateLimitMiddleware(metrics, config);
}
...
export const WEBSOCKET_RATE_LIMIT_PRESETS = {
  general: (): Partial<AdvancedWebSocketRateLimitConfig> =>
    WebSocketRateLimitMiddleware.createGeneralConfig(),

  strict: (): Partial<AdvancedWebSocketRateLimitConfig> =>
    WebSocketRateLimitMiddleware.createStrictConfig(),

  gaming: (): Partial<AdvancedWebSocketRateLimitConfig> =>
    WebSocketRateLimitMiddleware.createGamingConfig(),

  chat: (): Partial<AdvancedWebSocketRateLimitConfig> =>
    WebSocketRateLimitMiddleware.createChatConfig(),

  development: (): Partial<AdvancedWebSocketRateLimitConfig> =>
    WebSocketRateLimitMiddleware.createDevelopmentConfig(),

  production: (): Partial<AdvancedWebSocketRateLimitConfig> =>
    WebSocketRateLimitMiddleware.createProductionConfig(),
} as const;
