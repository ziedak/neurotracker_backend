 ...
 */
export class LoggingHttpMiddleware extends BaseMiddleware<LoggingHttpMiddlewareConfig> {
  constructor(
    metrics: IMetricsCollector,
    config: Partial<LoggingHttpMiddlewareConfig> = {}
  ) {
 ...
 */
export function createLoggingHttpMiddleware(
  metrics: IMetricsCollector,
  config?: Partial<LoggingHttpMiddlewareConfig>
...
export const LOGGING_PRESETS = {
  development: (): Partial<LoggingHttpMiddlewareConfig> =>
    LoggingHttpMiddleware.createDevelopmentConfig(),

  production: (): Partial<LoggingHttpMiddlewareConfig> =>
    LoggingHttpMiddleware.createProductionConfig(),

  audit: (): Partial<LoggingHttpMiddlewareConfig> =>
    LoggingHttpMiddleware.createAuditConfig(),

  minimal: (): Partial<LoggingHttpMiddlewareConfig> =>
    LoggingHttpMiddleware.createMinimalConfig(),

  debug: (): Partial<LoggingHttpMiddlewareConfig> => ({
    name: "logging-debug",
    logLevel: "debug",
    logRequestBody: true,
    logResponseBody: true,
  ...
  performance: (): Partial<LoggingHttpMiddlewareConfig> => ({
