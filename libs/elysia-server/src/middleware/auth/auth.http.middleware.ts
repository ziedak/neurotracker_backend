 ...
 */
export class AuthHttpMiddleware extends BaseMiddleware<AuthHttpMiddlewareConfig> {
  constructor(
    metrics: IMetricsCollector,
    private readonly authService: AuthenticationService,
    config: Partial<AuthHttpMiddlewareConfig> = {}
  ) {
 ...
 */
export function createAuthHttpMiddleware(
  metrics: IMetricsCollector,
...
export const AUTH_PRESETS = {
  requireAuth: (): Partial<AuthHttpMiddlewareConfig> =>
    AuthHttpMiddleware.createRequireAuthConfig(),

  optionalAuth: (): Partial<AuthHttpMiddlewareConfig> =>
    AuthHttpMiddleware.createOptionalAuthConfig(),

  adminOnly: (): Partial<AuthHttpMiddlewareConfig> =>
    AuthHttpMiddleware.createRoleBasedConfig(["admin"]),

  userOrAdmin: (): Partial<AuthHttpMiddlewareConfig> =>
    AuthHttpMiddleware.createRoleBasedConfig(["user", "admin"]),

  apiAccess: (): Partial<AuthHttpMiddlewareConfig> => ({
  ...
  webApp: (): Partial<AuthHttpMiddlewareConfig> => ({
    name: "auth-webapp",
    requireAuth: false,
    jwtAuth: true,
    sessionAuth: true,
  ...
  development: (): Partial<AuthHttpMiddlewareConfig> => ({
  ...
  production: (): Partial<AuthHttpMiddlewareConfig> => ({
