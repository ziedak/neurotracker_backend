 ...
 */
export interface CorsWebSocketMiddlewareConfig
 ...
 */
export class CorsWebSocketMiddleware extends BaseWebSocketMiddleware<CorsWebSocketMiddlewareConfig> {
  constructor(
    metrics: IMetricsCollector,
    config: Partial<CorsWebSocketMiddlewareConfig> = {}
  ) {
    // Create complete configuration with validated defaults
    const completeConfig: CorsWebSocketMiddlewareConfig = {
  ...
  ): Partial<CorsWebSocketMiddlewareConfig> {
    return {
 ...
 */
export function CorscreateWebSocketMiddleware(
  metrics: IMetricsCollector,
  config?: Partial<CorsWebSocketMiddlewareConfig>
...
export const WEBSOCKET_CORS_PRESETS = {
  development: (): Partial<CorsWebSocketMiddlewareConfig> =>
    CorsWebSocketMiddleware.createDevelopmentConfig(),

  production: (
    origins: readonly string[]
  ): Partial<CorsWebSocketMiddlewareConfig> =>
    CorsWebSocketMiddleware.createProductionConfig(origins),

  realtime: (
    origins: readonly string[]
  ): Partial<CorsWebSocketMiddlewareConfig> =>
    CorsWebSocketMiddleware.createRealtimeConfig(origins),

  strict: (
    origins: readonly string[]
  ): Partial<CorsWebSocketMiddlewareConfig> =>
    CorsWebSocketMiddleware.createStrictConfig(origins),
