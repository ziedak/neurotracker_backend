 ...
 */
export type MiddlewareFunction = (context: MiddlewareContext, next: () => Promise<void>) => Promise<void> | void;
/**
...
export interface MiddlewareChainConfig {
    ...
    errorHandler?: (error: Error, context: MiddlewareContext) => unknown | undefined;
}
