...
/* c8 ignore start */
const PROCESS = (typeof process === "object" && !!process ? process : {}) as {
  [k: string]: any;
};
/* c8 ignore start */
...
export class LRUCache<K extends {}, V extends {}, FC = unknown> {
  ...
  >(c: LRUCache<K, V, FC>) {
    return {
      ...
      backgroundFetch: (
        ...
        c.#backgroundFetch(k, index as Index | undefined, options, context),
  ...
  *rvalues() {
  ...
  memo(
    k: K,
    memoOptions: LRUCache.MemoOptions<K, V, FC> = {
      context: undefined,
      forceRefresh: false,
      allowStale: this.allowStale,
      updateAgeOnGet: this.updateAgeOnGet,
