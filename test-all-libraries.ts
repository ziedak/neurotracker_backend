...
try {
  ...
  const { DatabaseFactory } = await import(
    "./libs/database/src/factories/serviceFactory"
  );
...
try {
  ...
  const { MetricsCollector, PrometheusMetricsCollector } = await import(
    "./libs/monitoring/src/index"
  );

  console.log("   ✅ MetricsCollector imported:", typeof MetricsCollector);
  console.log(
    "   ✅ PrometheusMetricsCollector imported:",
    typeof PrometheusMetricsCollector
  );
  ...
  console.log(
    "   ✅ PrometheusMetricsCollector.create() works:",
    typeof prometheusMetrics
  );
